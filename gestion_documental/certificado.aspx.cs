...
namespace gestion_documental
{
    public partial class certificado : System.Web.UI.Page
    {
        ...
        protected void bt_buscar_Click(object sender, EventArgs e)
        {
            ...
            DataTable data =new DataTable();
            proce.consultacamposcondicion("indicecolegio i join documentos d on i.iddocumento=d.idDOCUMENTOS","d.*,i.colegio as colegio,i.municipio as municipio,i.year as year,i.grado as grado,i.libro as libro"," i.idserie='240' and i.idsubserie='929'"+municipio+year+colegio+grado+" limit 60",data);
        ...
        {
            if (Convert.ToInt32(txtgradoimprimir.Text) == 0)
            {
                txtgradoimprimir.Text = "CERO DE PRIMARIA";
            }
            else
            {
                if (Convert.ToInt32(txtgradoimprimir.Text) == 1)
                {
                    txtgradoimprimir.Text = "PRIMERO DE PRIMARIA";
                }
                else
                {
                    if (Convert.ToInt32(txtgradoimprimir.Text) == 2)
                    {
                        txtgradoimprimir.Text = "SEGUNDO DE PRIMARIA";
                    }
                    else
                    {
                        if (Convert.ToInt32(txtgradoimprimir.Text) == 3)
                        {
                            txtgradoimprimir.Text = "TERCERO DE PRIMARIA";
                        }
                        else
                        {
                            if (Convert.ToInt32(txtgradoimprimir.Text) == 4)
                            {
                                txtgradoimprimir.Text = "CUARTO DE PRIMARIA";
                            }
                            else
                            {
                                if (Convert.ToInt32(txtgradoimprimir.Text) == 5)
                                {
                                    txtgradoimprimir.Text = "QUITO DE PRIMARIA";
                                }
                                else
                                {
                                    if (Convert.ToInt32(txtgradoimprimir.Text) == 6)
                                    {
                                        txtgradoimprimir.Text = "SEXTO DE BACHIDERATO";
                                    }
                                    else
                                    {
                                        if (Convert.ToInt32(txtgradoimprimir.Text) == 7)
                                        {
                                            txtgradoimprimir.Text = "SEPTIMO DE BACHIDERATO";
                                        }
                                        else
                                        {
                                            if (Convert.ToInt32(txtgradoimprimir.Text) == 8)
                                            {
                                                txtgradoimprimir.Text = "OCTAVO DE BACHIDERATO";
                                            }
                                            else
                                            {
                                                if (Convert.ToInt32(txtgradoimprimir.Text) == 9)
                                                {
                                                    txtgradoimprimir.Text = "NOVENO DE BACHIDERATO";
                                                }
                                                else
                                                {
                                                    if (Convert.ToInt32(txtgradoimprimir.Text) == 10)
                                                    {
                                                        txtgradoimprimir.Text = "DECIMO DE BACHIDERATO";
                                                    }
                                                    else
                                                    {
                                                        if (Convert.ToInt32(txtgradoimprimir.Text) == 11)
                                                        {
                                                            txtgradoimprimir.Text = "ONCE DE BACHIDERATO";
                                                        }
                                                        else
                                                        {
