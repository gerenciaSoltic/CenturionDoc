<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventarioContratacion.aspx.cs" Inherits="gestion_documental.InventarioContratacion" %>
...
<body>
    ...
    <div id="navigation">
            ...
            <td class="style24">
             ...
             <td  class="style24">
             <input id="Button2" type="button" value="Cerrar" onclick="javascript:cerrar()"  />
            </td>
             <td class="style24">
   ...
   <br />
   <div id="Div1" style="width:1700px; height:1060px; border-color:Black; border-width:1px; border: 2px groove threedface;">
         <br />
         <div id="Print" style="width:1700px; height:1060px;">
        ...
        <asp:GridView ID="GVPRINCIPAL" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Nombre del Contratista">
                 <ItemTemplate>
                        <asp:TextBox ID="txtexpedientelaboral" runat="server"  Width="300px" Text='<%# Eval("expedientelaboral")%>'></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Cedula o Nit">
                 <ItemTemplate>
                        <asp:TextBox ID="txtcedula" runat="server"  Width="70px" Text='<%# Eval("cedula")%>'></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Objeto">
                    <ItemTemplate>
                        <asp:TextBox ID="txtobjeto" runat="server" Width="70px" Text='<%# Eval("objeto")%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="N° Contrato">
                    <ItemTemplate>
                        <asp:TextBox ID="txtnumerocontrato" runat="server" Width="70px" Text='<%# Eval("numerocontrato")%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:CheckBox ID="cksticker" runat="server" oncheckedchanged="cksticker_CheckedChanged" />
                    </ItemTemplate>
                </asp:TemplateField>
