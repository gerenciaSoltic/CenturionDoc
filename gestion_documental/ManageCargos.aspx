<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ManageCargos.aspx.cs" Inherits="gestion_documental.ManageCargos" %>
                ...
                <div style="overflow: hidden;">
                            ...
                            <div style="width: 100%; float: right;">
                                <table style="margin: 0 auto;">
                                    ...
                                    <tr>
                                        <td>
                                            CARGOS<asp:RequiredFieldValidator ID="rfvAtributo" runat ="server" SetFocusOnError="true" ControlToValidate ="txtCargo" CssClass="errorMessage" ErrorMessage="*" ValidationGroup="Ente"></asp:RequiredFieldValidator>:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="ChkLider" runat="server" Text="Lider" />
                                        </td>
                            ...
                            <div class="Log" style="width: 100%; float: left;">
                                <asp:GridView runat="server" ID="gvEnte" AutoGenerateColumns="False"
                                    Width="100%" DataKeyNames="IDCARGO" 
