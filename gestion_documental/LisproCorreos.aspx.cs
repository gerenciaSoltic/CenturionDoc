...
{
    public partial class LisproCorreos : System.Web.UI.Page
    {
        ...
        protected void procesarCorreos(Pop3Client cliente)
        {
            ...
            int cant = cliente.GetMessageCount();
                ...
                if (cant > 0)
                {
                    try
                    {
                        MessageHeader cabecera = cliente.GetMessageHeaders(1);


                        for (int i = 1; i <= cant; i++)
                        {

                            cabecera = cliente.GetMessageHeaders(i);
                            ...
                            if ((cabecera != null && message != null) || (cabecera.From.Address.Trim() != receptor.conficor.EMAIL.Trim()))
                            {
                                try
                                {
                                    ...
                                    correo.FECHA = cabecera.DateSent;
        ...
        private void Eliminar()
        {
            ...
            new CorreoEntranteManagement().DeleteCorreoEntrante(Convert.ToInt32(correosGridView.SelectedDataKey.Values[0]));
            cargarCorreosElectronicos();
            ...
            if (contador == 0)
            {
                ...
                */
                ...
                if (okAtributos)
                {
                    ...
                    new RadicadosManagement().UpdateRadicados(new RadicadosManagement().GetRadicadoExterno(receptor,false));
