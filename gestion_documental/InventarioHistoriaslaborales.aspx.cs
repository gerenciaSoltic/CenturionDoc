...
{
    public partial class InventarioHistoriaslaborales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataColumn expedientelaboral = new DataColumn("expedientelaboral");
                expedientelaboral.DataType = System.Type.GetType("System.String");
                data.Columns.Add(expedientelaboral);

                DataColumn cedula = new DataColumn("cedula");
                cedula.DataType = System.Type.GetType("System.String");
        ...
        public void crearfila()
        {
            ...
            foreach (GridViewRow row in GVPRINCIPAL.Rows)
            {
                ...
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    TextBox expedientelaboral = row.Cells[1].FindControl("txtexpedientelaboral") as TextBox;
                    fila1["expedientelaboral"] = expedientelaboral.Text;
                    TextBox cedula = row.Cells[1].FindControl("txtcedula") as TextBox;
                    fila1["cedula"] = cedula.Text;
                            ...
                            else
                            {
                                if (Session["opcion"].ToString() == "copiar")
                                {
                                    ...
                                    if (ckcopi.Checked)
                                    {
                                        ...
                                        filanueva1["expedientelaboral"] = fila1["expedientelaboral"];

                                        filanueva1["cedula"] = fila1["cedula"];

                                        proce.insertaralgunos("inventario", "caja,numeroorden,codigo,nombreserie,cedula,idoficinaproductora,idinstitucion,fechainicio,fechafinal,numerofolios,volumen,expedientelaboral", "'" + fila1["caja"] + "','" + fila1["numeroorden"] + "','" + fila1["codigo"] + "','" + fila1["nombreserie"] + "','" + fila1["cedula"] + "','" + DDLoficinaproductora.SelectedValue + "','" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + "','" + fila1["fechainicio"] + "','" + fila1["fechafinal"] + "','" + fila1["numerofolios"] + "','" + fila1["volumen"] + "','" + fila1["expedientelaboral"] + "'");
                                   ...
                                   if (Session["opcion"].ToString() == "grabar")
                                    {
                                        ...
                                        proce.insertaralgunos("inventario", "idoficinaproductora,caja,numeroorden,codigo,nombreserie,fechainicio,fechafinal,unidadconservacion,numerofolios,soporte,volumen,expedientelaboral,cedula,idinstitucion,color", DDLoficinaproductora.SelectedValue + ",'" + caja.Text + "','" + numeroorden.Text + "','" + codigo.Text + "','" + nombreserie.Text + "','" + fechainicio.Text + "','" + fechafinal.Text + "','" + unidadconservacion + "','" + numerofolios.Text + "','" + soporte.Text + "','" + volumen.Text + "','" + expedientelaboral.Text + "','" + cedula.Text + "','" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + "','" + color.Text + "'");
                                    ...
                                    else
                                    {
                                        if (Session["opcion"].ToString() == "update")
                                        {
                                            ...
                                            if (expedientelaboral.Text.Length > 200)
                                            {
                                                expedientelaboral.Text = expedientelaboral.Text.Substring(0, 199);
                                            }

                                            proce.editar("oficinaproductora", "year='" + txtano.Text + "', mes='" + txtmes.Text + "', dia = '" + txtdia.Text + "', nt='" + txtnt.Text + "',objeto='" + Session["objeto"].ToString() + "'", "idinstitucion=" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and id='" + DDLoficinaproductora.SelectedValue + "'");
                                            proce.editar("inventario", "caja='" + caja.Text + "', numeroorden = '" + numeroorden.Text + "', codigo='" + codigo.Text + "',nombreserie='" + nombreserie.Text + "', fechainicio='" + fechainicio.Text + "', fechafinal = '" + fechafinal.Text + "', unidadconservacion='" + unidadconservacion + "',numerofolios='" + numerofolios.Text + "', soporte='" + soporte.Text + "', volumen = '" + volumen.Text + "', expedientelaboral='" + expedientelaboral.Text + "',cedula='"+cedula.Text+"',color='" + color.Text + "'", "idinstitucion=" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora='" + DDLoficinaproductora.SelectedValue + "' and id='" + id.Text + "'");
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                if (Session["opcion"].ToString() == "eliminarr")
                                                {
                                                    ...
                                                    {
                                                       proce.insertaralgunos("inventariocontratacion", "idoficinaproductora,caja,numeroorden,codigo,nombreserie,fechainicio,fechafinal,numerofolios,soporte,volumen,nombrecontratista,cedula,idinstitucion,color", DDLoficinaproductora.SelectedValue + ",'" + caja.Text + "','" + numeroorden.Text + "','" + codigo.Text + "','" + nombreserie.Text + "','" + fechainicio.Text + "','" + fechafinal.Text + "','" + numerofolios.Text + "','" + soporte.Text + "','" + volumen.Text + "','" + expedientelaboral.Text + "','" + cedula.Text + "','" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + "','" + color.Text + "'");
                                                       proce.eliminar("inventario", "id='" + id.Text + "'");
                                                    }
                                                }
                                            }
                                        }
        ...
        public void llenarstikert(TextBox color,TextBox id,TextBox caja)
        {
            ...
            Session["stikertabla"] = "inventario";
            Session["stikerobservacion"] = "expedientelaboral,i.cedula";
        ...
        protected void GVPRINCIPAL_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                var db = (LinkButton)e.Row.Cells[19].Controls[0];
        ...
        protected void btgrabar_Click(object sender, EventArgs e)
        {
            if (DDLoficinaproductora.Items.Count > 0)
            {
                ...
                DataTable data = new DataTable();
                proce.consultacamposcondicion("inventario", "*", " idinstitucion =" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora='" + DDLoficinaproductora.SelectedValue + "'", data);
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            ...
            if (txtcedula1.Text != "" && txtcedula2.Text != "")
            {
                Session["condicionbuscar"] = " and Cast(cedula as Decimal) between '" + txtcedula1.Text + "' and '" + txtcedula2.Text + "'";
                cajas = 1;
            ...
            if (DDLoficinaproductora.Items.Count > 0)
            {
                ...
                DataTable data = new DataTable();
                proce.consultacamposcondicion("inventario", "*,'     ' as unidadcaja,'      ' as unidadcarpeta,'      ' as unidadtom,'     ' as unidadotros", " idinstitucion =" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora='" + DDLoficinaproductora.SelectedValue + "' " + Session["condicionbuscar"].ToString()+" order by cedula ASC", data);
                ...
                if (data.Rows.Count > 0)
                {
                    for (int i = 0; i < data.Rows.Count; i++)
                    {
                        if (cajas == 1)
                        {
                            data.Rows[i]["caja"] = txtnumerocaja.Text;
                            data.Rows[i]["numeroorden"] = i + 1;
        ...
        {
            proce.eliminar("inventario", "idinstitucion =" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora ='" + DDLoficinaproductora.SelectedValue + "'");
            blanquearproyecto();
            GVPRINCIPAL.DataSource = "";
            GVPRINCIPAL.DataBind();
        }
                        ...
                        for (int colIndex = row.FirstColIndex; colIndex <= row.LastColIndex; colIndex++)
                        {
                            ...
                            switch (colIndex)
                            {
                                ...
                                case 13:
                                    ...
                                    break;
                                case 14:
                                    Fila["expedientelaboral"] = cell.Value;
                                    break;
                                case 15:
                                    Fila["cedula"] = cell.Value;
                                    break;
                            }
        ...
        public void obtenerid()
        {
            ...
            DataAccessLayer.stikercajaconsul.tabla = "inventario";
            DataAccessLayer.stikercajaconsul.campo = "expedientelaboral,i.cedula";
            ...
            if (cktodo.Checked == true)
            {
                ...
                proce.consultacamposcondicion("inventario", "id,caja", "idoficinaproductora ='" + DDLoficinaproductora.SelectedValue + "' and color='.' " + Session["condicionbuscar"].ToString(), consul1);
                ...
                proce.consultacamposcondicion("inventario", "id", "idoficinaproductora ='" + DDLoficinaproductora.SelectedValue + "' and ( color !='.' or color is null)" + Session["condicionbuscar"].ToString(), consul);
