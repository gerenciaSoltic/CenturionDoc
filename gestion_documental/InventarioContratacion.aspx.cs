...
{
    public partial class InventarioContratacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataColumn objeto = new DataColumn("objeto");
                objeto.DataType = System.Type.GetType("System.String");
                data.Columns.Add(objeto);
        ...
        public void crearfila()
        {
            ...
            foreach (GridViewRow row in GVPRINCIPAL.Rows)
            {
                ...
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    TextBox objeto = row.Cells[1].FindControl("txtobjeto") as TextBox;
                    fila1["objeto"] = objeto.Text;
                    TextBox numerocontrato = row.Cells[1].FindControl("txtnumerocontrato") as TextBox;
                    fila1["numerocontrato"] = numerocontrato.Text;
                            ...
                            else
                            {
                                if (Session["opcion"].ToString() == "copiar")
                                {
                                    ...
                                    if (ckcopi.Checked)
                                    {
                                        ...
                                        filanueva1["objeto"] = fila1["objeto"];

                                        filanueva1["numerocontrato"] = fila1["numerocontrato"];
        ...
        protected void GVPRINCIPAL_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                var db = (LinkButton)e.Row.Cells[21].Controls[0];
        ...
        protected void btgrabar_Click(object sender, EventArgs e)
        {
            if (DDLoficinaproductora.Items.Count > 0)
            {
                ...
                DataTable data = new DataTable();
                proce.consultacamposcondicion("inventariocontratacion", "*", " idinstitucion =" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora='" + DDLoficinaproductora.SelectedValue + "'", data);
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable data = new DataTable();
                proce.consultacamposcondicion("inventariocontratacion", "*,nombrecontratista as expedientelaboral,'     ' as unidadcaja,'      ' as unidadcarpeta,'      ' as unidadtom,'     ' as unidadotros", " idinstitucion =" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora='" + DDLoficinaproductora.SelectedValue + "'", data);
        ...
        protected void bteditar_Click(object sender, EventArgs e)
        {
            if (DDLoficinaproductora.Items.Count > 0)
            {
                proce.eliminar("inventariocontratacion", "idinstitucion =" + SessionDocumental.UsuarioInicioSession.IDINSTITUCION + " and idoficinaproductora ='" + DDLoficinaproductora.SelectedValue + "'");
                Session["opcion"] = "grabar";
                crearfila();
                blanquearproyecto();
            }
                        ...
                        for (int colIndex = row.FirstColIndex; colIndex <= row.LastColIndex; colIndex++)
                        {
                            ...
                            switch (colIndex)
                            {
                                ...
                                case 15:
                                    ...
                                    break;
                                case 16:
                                    Fila["objeto"] = cell.Value;
                                    break;
                                case 17:
                                    Fila["numerocontrato"] = cell.Value;
                                    break;
                            }
        ...
        protected void btimprimisticker_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~//reporting/caja.aspx", "_blank", " menubar=0,scrollbars=1,width=780,height=900,top=10");
            }
            else
            {
        ...
        {
            DataAccessLayer.stikercajaconsul.tabla = "inventariocontratacion";
            DataAccessLayer.stikercajaconsul.campo = "objeto";
        ...
        protected void btimprimirstickercarpeta_Click(object sender, EventArgs e)
        {
            ...
            if (DataAccessLayer.stikercajaconsul.idsticker != "")
            {
                Response.Redirect("~//reporting/carpeta.aspx", "_blank", " menubar=0,scrollbars=1,width=780,height=900,top=10");
            }
            else
            {
