<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InfWorkFlow.aspx.cs" Inherits="gestion_documental.InfWorkFlow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Titulo" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Informe Sobre Configuración de Oficinas Productoras- Series - Subseries- Tipologias"></asp:Label>
</asp:Content>
...
<tr>
   ...
   <td class="style1">
    <asp:Label ID="Label4" runat="server" Text="Oficina productora"></asp:Label>
    <asp:DropDownList ID="DDLEnte" runat="server" Height="20px" 
           style="margin-left: 10px" Width="346px" AutoPostBack="True" onselectedindexchanged="DDLEnte_SelectedIndexChanged" 
           >
    </asp:DropDownList>
    </td>
   <td class="style1">
...
<td>
    <asp:GridView ID="GrdTRD" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:BoundField DataField="codente" HeaderText="Cod. Oficina" />
            <asp:BoundField DataField="ente" HeaderText="Oficina" />
