<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inventarioCustodia.aspx.cs" Inherits="gestion_documental.inventarioCustodia" %>
...
<body>
    ...
    <div id="navigation">
            ...
            <tr>
            <td class="style24">
                <asp:Button ID="btreportes" runat="server" Text="Reportes" 
                    onclick="btreportes_Click" />
            </td>
             <td  class="style24">
               ...
               <td class="style24">
                ...
                <td>
                    ...
                    <asp:Button ID="btimprimirstickercarpeta" runat="server" Text="Sticker Carpeta" 
                        onclick="btimprimirstickercarpeta_Click" Visible="False" />
                    <asp:Button ID="Button3" runat="server" Width="130px"  Text="Sticker Pequeño" 
   ...
   <div id="Div1" style="width:1575; height:1060px; border-color:Black; border-width:1px; border: 2px groove threedface;">
    ...
    <tr>
    <td class="style2">
        <asp:Image ID="imagenempresa" runat="server" src="./../Images/Logo-ISSO.png"   style="height: 96px; width: 170px" />
    </td>
    ...
    <td class="style2">
        <asp:Image ID="imagenempresa0" runat="server" src="../Images/Logo-ISSO.png" 
    ...
    <td style="border: medium double #000000">
    <table align="center">
    <tr>
    <td>
        <asp:Label ID="Label23" runat="server" Text="TERCERO DEL INVENTARIO"></asp:Label>
    </td>
    </tr>
    </table>
    <br />
    ...
    <tr>
    <td>
        <asp:Label ID="Label24" runat="server" Text="NIT : "></asp:Label>
    </td>
    <td>
        <asp:TextBox ID="txtnittercero" runat="server" Width="130px" 
            AutoPostBack="True" ontextchanged="txtnittercero_TextChanged"></asp:TextBox>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <td>
        <asp:TextBox ID="txtnombretercero" runat="server" Width="344px" Enabled="False"></asp:TextBox>
    </td>
    </tr>
    </table>
    <table align="center">
    ...
    <td>
        <asp:ImageButton ID="ImageButton1" runat="server"  
            ImageUrl="~/Images/buscar.jpg"  Height="20px"  Width="61px" 
    ...
    <br />
    <br />
    <div align="center" style="border: medium double #000000">
    <br />
    <table>
    <tr>
    <td>
        &nbsp;</td>
    <td>
        Desde la caja cliente</td>
    <td>
        <asp:TextBox ID="txtcajaclienteini" runat="server"></asp:TextBox>
        </td>
    <td >
        <asp:Label ID="Label18" runat="server" Text="Hasta la caja cliente"></asp:Label>
       </td>
         <td>
             <asp:TextBox ID="txtcajaclientefin" runat="server"></asp:TextBox>
            </td>
    <td>
        &nbsp;</td>
    ...
    <div align="center">
        <asp:GridView ID="GVPRINCIPAL" runat="server" AutoGenerateColumns="False" 
            ...
            OnRowDeleting="GVPRINCIPAL_RowDeleting" DataKeyNames="prestamo">
            <Columns>
                ...
                <asp:TemplateField HeaderText="N° Orden">
                 ...
                 <asp:TemplateField HeaderText="Caja Cliente">
                    <ItemTemplate>
                        <asp:TextBox ID="txtcajacliente" runat="server" Width="50px" Text='<%# Eval("cajacliente")%>'></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="Caja">
                ...
                <asp:TemplateField HeaderText="Unidad Tomo">
                 <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="REF Caja">
                 <ItemTemplate>
                        <asp:TextBox ID="txtrefcaja" runat="server"  Width="60px" Text='<%# Eval("refcaja")%>'></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                </asp:TemplateField>
                ...
                <asp:CommandField HeaderText="ver prestamo" ShowSelectButton="True" />
            </Columns>
    ...
    <div>
         <asp:Panel ID="PanelModal" runat="server" style=" display:none;  background:white; width:60%; height:80%" BorderColor="Blue" BorderStyle="Double">
        ...
        <br />
              ...
              <div >
                  <asp:GridView ID="gvpaneltercero" runat="server" CellPadding="4" ForeColor="#333333" 
                      GridLines="None" style="margin-right: 570px"  Width="950px" DataKeyNames="nit,referencia"
              ...
              <div>
               ...
               <div>
         <asp:Panel ID="panelsticker" runat="server" style=" display:none;  background:white; width:40%; height:40%" BorderColor="Blue" BorderStyle="Double">
                  <br />
                  <br />
                  <br />
                  <br />
                  ...
                  <br />
                   ...
                   <tr>
                   <td>
                       <asp:Label ID="Label26" runat="server" Text="Numero del stickert actual :"></asp:Label>
                   </td>
                   <td>
                       <asp:Label ID="lbconsecutivo" runat="server" Text="0"></asp:Label>
                   </td>
                   </tr>
                   <tr>
                   <td>
                       <asp:Label ID="Label27" runat="server" Text="Inicio del stickert a generar :"></asp:Label>
                   </td>
                    <td>
                        <asp:TextBox ID="txtconsecutivoagenerar" runat="server"></asp:TextBox>
                   </td>
                   </tr>
                   <tr>
                   <td>
                       <asp:Label ID="Label28" runat="server" Text="Cantidad de stickert"></asp:Label>
                   </td>
                   <td>
                       <asp:TextBox ID="txtcantidadstickert" runat="server"></asp:TextBox>
                   </td>
                   </tr>
                   </table>
                   <br />
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Button ID="btsalir" runat="server" Text="Cerrar" onclick="btsalir_Click" />
                   </div>
        
                  <asp:HiddenField ID="HiddenField2" runat="server" />
                  <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" 
                      DynamicServicePath="" Enabled="True" PopupControlID="panelsticker" 
                      TargetControlID="HiddenField2">
                  </asp:ModalPopupExtender>
             
              </asp:Panel>
              </div>
                <asp:Panel ID="panelprestamo" runat="server" style=" display:none;  background:white; width:40%; height:40%" BorderColor="Blue" BorderStyle="Double">
                  <br />
                  <br />
                  <br />
                  <br />
                  ...
                  <br />
                   ...
                   <tr>
                   <td>
                      <asp:Label ID="Label29" runat="server" Text="Codigo del prestamo : "></asp:Label>
                   </td>
                   <td>
                      <asp:Label ID="lbcodigodelprestamo" runat="server" Text=""></asp:Label>
                   </td>
                   </tr>
                   <tr>
                   <td>
                       <asp:Label ID="Label19" runat="server" Text="Recibio : "></asp:Label>
                   </td>
                   <td>
                       <asp:Label ID="lbrecibio" runat="server" Text=""></asp:Label>
                   </td>
                   </tr>
                   <tr>
                   <td>
                   ...
                   <tr>
                   <td>
                       <asp:Label ID="Label31" runat="server" Text="Fecha del prestamo : "></asp:Label>
                   </td>
                   <td>
                       <asp:Label ID="lbfechaprestamo" runat="server" Text=""></asp:Label>
                   </td>
                   </tr>
                   </table>
                   <br />
                   <br />
                       <asp:Button ID="Button2" runat="server" Text="Cerrar" onclick="btsalir_Click" />
                   </div>
        
                  <asp:HiddenField ID="HiddenField3" runat="server" />
                  <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" 
                      DynamicServicePath="" Enabled="True" PopupControlID="panelprestamo" 
