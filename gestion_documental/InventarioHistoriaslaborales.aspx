<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventarioHistoriaslaborales.aspx.cs" Inherits="gestion_documental.InventarioHistoriaslaborales" %>
...
<body>
   ...
   <div id="Div1" style="width:1575; height:1060px; border-color:Black; border-width:1px; border: 2px groove threedface;">
    ...
    <tr>
    <td>
        <asp:Label ID="Label18" runat="server" Text="Desde la Cedula"></asp:Label>
    </td>
    <td>
        <asp:TextBox ID="txtcedula1" runat="server"></asp:TextBox>
    </td>
    <td>
        <asp:Label ID="Label19" runat="server" Text="Hasta la Cedula"></asp:Label>
    </td>
    <td>
        <asp:TextBox ID="txtcedula2" runat="server"></asp:TextBox>
    </td>
    <td>
        <asp:Label ID="Label22" runat="server" Text="caja"></asp:Label>
    </td>
    <td class="style29">
    
        <asp:TextBox ID="txtnumerocaja" runat="server"></asp:TextBox>
    ...
    <div align="center">
     <asp:Label ID="Label23" runat="server" Text="Cantidad de registros"></asp:Label>  
        &nbsp;  
    ...
    <div align="center">
        <asp:GridView ID="GVPRINCIPAL" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Expedientes Laborales">
                 <ItemTemplate>
