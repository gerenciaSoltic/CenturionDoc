<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageFormatos.aspx.cs" Inherits="gestion_documental.ManageFormatos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Titulo" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Formatos Nuevos documentos por Oficina Productora"></asp:Label>
</asp:Content>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <td>
            <asp:TextBox ID="TxtDescripcion" runat="server" Width="501px"></asp:TextBox>
        ...
        <td>
            ...
            <asp:FileUpload ID="FileUpload1" runat="server" Width="524px" />
        </td>
        </tr>
        <tr>
        <td>
