<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Procesos.aspx.cs" Inherits="gestion_documental.Procesos" %>
                ...
                <div style="overflow: hidden;">
                            ...
                            <div style="width: 100%; float: right;">
                                <table style="margin: 0 auto;">
                                   ...
                                   <tr><td></td>
                                        <td   align="left">
                                         <asp:RequiredFieldValidator ID="rfvSerie" runat ="server" SetFocusOnError="true" ControlToValidate ="txtSerie" CssClass="errorMessage" ErrorMessage="Por Favor entre el proceso !" ValidationGroup="Serie"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
