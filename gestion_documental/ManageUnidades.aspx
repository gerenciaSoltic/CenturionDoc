<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ManageUnidades.aspx.cs" Inherits="gestion_documental.ManageUnidades" %>
                ...
                <div style="overflow: hidden;">
                            ...
                            <div class="Log" style="width: 100%; float: left;">
                                <asp:GridView runat="server" ID="gvSerie" AutoGenerateColumns="False"
                                    Width="100%" DataKeyNames="idunidades" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IDUNIDADES" HeaderText="Id" />
