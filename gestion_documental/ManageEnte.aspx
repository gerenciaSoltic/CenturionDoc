<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ManageEnte.aspx.cs" Inherits="gestion_documental.ManageEnte" %>
                ...
                <div style="overflow: hidden;">
                            ...
                            <div style="width: 100%; float: right;">
                                <table style="margin: 0 auto;">
                                    ...
                                    <tr>
                                        <td>
                                            Codigo<asp:RequiredFieldValidator ID="rfvCodigo" runat ="server" SetFocusOnError="true" ControlToValidate ="txtCodigo" CssClass="errorMessage" ErrorMessage="*" ValidationGroup="Ente"></asp:RequiredFieldValidator>:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            Descripción<asp:RequiredFieldValidator ID="rvftxtDescripcion" runat ="server" SetFocusOnError="true" ControlToValidate ="txtDescripcion" CssClass="errorMessage" ErrorMessage="*" ValidationGroup="Ente"></asp:RequiredFieldValidator>:
                                        </td>
                                        <td>
                            ...
                            <div class="Log" style="width: 100%; float: left;">
                                <asp:GridView runat="server" ID="gvEnte" AutoGenerateColumns="False"
                                    Width="100%" DataKeyNames="IDENTE" 
                                    OnSelectedIndexChanged="gvEnte_SelectedIndexChanged" 
                                    OnRowDeleting="gvEnte_DeleteEventHandler" 
                                    OnRowDataBound="gvShowEnte_RowDataBound" CellPadding="4" ForeColor="#333333" 
                                    GridLines="None">
                                    <AlternatingRowStyle BackColor="White" />
                                    <Columns>
                                        <asp:BoundField DataField="IDENTE" HeaderText="Id" />
