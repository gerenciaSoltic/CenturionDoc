<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LisproCorreos.aspx.cs" Inherits="gestion_documental.LisproCorreos" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
  <table border="0" width="100%" cellpadding="10"><tr><td>
    <asp:Panel ID="panelContenedor" runat="server" Width="100%" Height="100%" CssClass="" GroupingText="Correo Entrante">
        ...
        <br />
       RADICADO <asp:TextBox ID="TxtRadicado" runat="server" Width="247px" Enabled="False"></asp:TextBox>
        <br />
